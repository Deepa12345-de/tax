                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div id="media_image-1" class="widget widget_media_image">
                            <a href="index.php"><img src="<?php echo  $logoPath?>" alt=""></a>
                        </div>
                        <div id="custom_html-1" class="widget_text widget widget_custom_html">
                            <div class="textwidget custom-html-widget">
                            <p>TexSquire is committed to providing cutting-edge billing software solutions that streamline financial processes for businesses of all sizes. Our platform simplifies invoicing, payment management, and compliance to help businesses operate more efficiently and securely.</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <section id="mc4wp_form_widget-1" class="widget widget_mc4wp_form_widget">
                            ...
                            <form id="mc4wp-form-1" class="mc4wp-form mc4wp-form-1696" method="post" data-id="1696" data-name="TexEsquire Subscribe">
