                        ...
                        <div class="wpb_wrapper">
                            <div class="row wpb_row inner row-fluid row-o-equal-height row-o-content-middle row-flex">
                                ...
                                <div class="bg-second wpb_column column_container col-sm-12 col-md-6">
                                    <div class="column-inner">
                                        <div class="wpb_wrapper">
                                            <div class="empty_space_60 lg-hidden h60"><span
                                            ...
                                            <div class="wpb_text_column wpb_content_element padding-box-2 text-light">
                                                <div class="wpb_wrapper">
                                                    <p>TexEsquire is a powerful, easy-to-use billing software designed
                                                        for small and medium-sized businesses. From generating
                                                        professional invoices and tracking payments to managing taxes
                                                        and reports, everything is streamlined in one place. With a
                                                        user-friendly interface and cloud-based access, TexEsquire helps
                                                        you save time, reduce errors, and stay on top of your finances
                                                        effortlessly..</p>
                                            ...
                                            <div class="empty_space_60 lg-hidden"><span
                                                    class="empty_space_inner"></span></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <span class="wpcf7-form-control-wrap your-service">
                                                <select name="your-service" class="wpcf7-form-control wpcf7-select"
                                                    aria-invalid="false">
